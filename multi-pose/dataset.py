...
class Dataset(object):
    ...
    def __init__(self, dataset_path, **kw):
        ...
        self.train_R = np.empty( (self.noof_training_imgs,) + (3,3))
    ...
    def batch(self, batch_size):
        ...
        batch_R, batch_x, masks, batch_y = self.train_R[rand_idcs], self.train_x[rand_idcs], self.mask_x[rand_idcs], self.train_y[rand_idcs]
        rand_vocs = self.bg_imgs[rand_idcs_bg]
        ...
        return (batch_x, batch_y, batch_R)
